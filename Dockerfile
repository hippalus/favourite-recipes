...
COPY --from=module-build --chown=1000:1000 /module/app/target/favourite-recipes-0.0.1-SNAPSHOT.jar ./favourite-recipes-0.0.1-SNAPSHOT.jar

ENTRYPOINT ["java", "-jar", "favourite-recipes-0.0.1-SNAPSHOT.jar"]
